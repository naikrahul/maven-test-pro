<form action="action_page.php">
  <div class="container">
    <h1>New user Register for DevOps Learning by RAHUL KUMAR</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>
     
    <label for="Name"><b>Enter YOUR Name</b></label>i
    <input type="text" placeholder="Enter Full Name" name="Name" id="Name" required><br>
    <label for="mobile"><b>Enter YOUR mobile</b></label>
    <input type="text" placeholder="Enter moible number" name="mobile" id="mobile" required><br>
